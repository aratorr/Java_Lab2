...
public Double calculate1(Double x, Double y, Double z) { 
	...
	return Math.pow(Math.log(Math.pow(1+x, 2)) + Math.cos(Math.pow(Math.PI*z, 3)), Math.sin(y)) + Math.pow(Math.pow(Math.E, Math.pow(x, 2)) + Math.cos(Math.pow(Math.E,z)) + Math.pow(1/y, 1/2), 1/x);
} 
...
public Double calculate2(Double x, Double y, Double z) { 
	...
	return Math.pow(Math.cos(Math.pow(Math.PI*x, 3)) + Math.log(Math.pow(1+y, 2)), 4)*(Math.pow(Math.E, Math.pow(z, 2)) + Math.pow(1/x, 1/2) + Math.cos(Math.pow(Math.E, y)));
}   
